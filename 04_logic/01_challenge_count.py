...
def solution(votes : str):
    ...
    votes = votes.upper()
    counter_r = votes.count("R")
    counter_j = votes.count("J")
    
    # for v in votes.upper():
    #     counter_r += 1 if v == "R" else 0
    #     counter_j += 1 if v == "J" else 0

    return counter_r == counter_j
